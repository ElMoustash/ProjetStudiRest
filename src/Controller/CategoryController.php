...
class CategoryController extends AbstractController
{
    ...
    public function new(Request $request): JsonResponse
    {
        ...
        $location = $this->urlGenerator->generate( 'app_api_restaurant_show',['id' => $category->getId()], UrlGeneratorInterface::ABSOLUTE_URL,
        );
    ...
    public function show(int $id): JsonResponse
    {
        ...
        if($category) {$responseData = $this->serializer->serialize($category, 'json');

            return new JsonResponse($responseData, Response::HTTP_OK, [],true);
        }

        return new JsonResponse("no category found", Response::HTTP_NOT_FOUND);
    }
